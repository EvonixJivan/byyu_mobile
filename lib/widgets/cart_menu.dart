...
class CartMenu extends StatefulWidget {
  ...
  dynamic a, o;
  CartMenu({this.a, this.o, this.cartController,this.fromPaymentScreen, 
...
class _CartMenuState extends State<CartMenu> {
  ...
  _CartMenuState(
      {this.a, this.o, this.cartController,this.fromPaymentScreen, 
      this.homeScreenSetState,
      this.callbackPaymentSetState
      });
  ...
  _getCartList1() async {
    try {
      ...
      // homeScreenSetState!();
       if (widget.fromPaymentScreen == true && widget.callbackPaymentSetState != null) {
