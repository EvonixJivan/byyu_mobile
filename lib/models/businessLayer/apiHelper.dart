...
class APIHelper {
  ...
  Future<dynamic> getAppInfo() async {
    try {
      ...
      print(
          "{'user_id': ${global.currentUser.id}, platform: ${platform}, app_name: customer, 'device_id': ${fcmToken},'actual_device_id' : ${global.globalDeviceId},  app_cur_version: ${version}");
  ...
  Future<dynamic> paymentError(String activityName, dynamic description) async {
    try {
      Response response;
      var dio = Dio();
      var formData = FormData.fromMap({
...
//
  ...
  Future<dynamic> getEventFilteredProducts(int eventID, int page, String catID,
    ...
    try {
      ...
      print(formData.fields);
      print(
          '${global.nodeBaseUrl}event_details?');
      response = await dio.post(
        '${global.nodeBaseUrl}event_details',
        data: {'user_id': global.currentUser != null ? global.currentUser.id : "",
        'event_id': eventID,
        "cat_id": catID,
        "cat_type": catType,
        "page":page,
  ...
  Future<dynamic> getFilteredProducts(int minAge, int maxAge, int genderID,
      int occassionID, int relationID,int page,ProductFilter productFilter,String cat_subCat_ID,String catType) async {
    print(
