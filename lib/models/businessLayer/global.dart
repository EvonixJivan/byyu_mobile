...
int cartCount = 0, isBannerShow = 0, wishlistCount = 0, showHamburgerMenu = 0;
...
String googleMapAPIKey =
    "AIzaSyCSfEYjknao_GTrv0-kIifoqxAWPzvCcJ0"; // byyu contact.byyu account key
//String googleMapAPIKey = "AIzaSyDXcuHIa4Hl64uIgoCzTcvQthuEBJZpeq8"; //hrms key
...
void showCartBottomSheet(context, a, o, refreshFunction) {
  showModalBottomSheet(
    ...
    print("Bottom sheet closed — refreshing now");
    if (refreshFunction != null) {
      refreshFunction();
    } else {
      print("⚠️ Refresh function is null");
    }
  });
}
...
Future<String> assetToFileUrl(String assetPath) async {
