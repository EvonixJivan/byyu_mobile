...
class _AllEventsScreenState extends BaseRouteState {
              ...
              _isDataLoaded
                  ...
                  ? Column(
                      children: [
                                                                        ...
                                                                        ? Container(
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              style: TextStyle(
                                                                                  ...
                                                                                  fontSize: 12,
                                                                                  overflow: TextOverflow.ellipsis,
                                                                                  color: subCateSelectIndex == index ? Colors.white : Colors.black),
                                                                            ),
                                                                          )
                                                                        : Container(
                                                                            // else  condition
                                    ...
                                    ? _productsList != null &&
                                        ...
                                        : Container(
                                            ...
                                            child: Padding(
                                              ...
                                              child: Center(
                                                  child: Text(
                                                _isDataLoading? "Loading...":"No products found",
                        ...
                        //                                                           maxLines: 2,
                        //                                                           textAlign: TextAlign.center,
                        //                                                           style: TextStyle(fontFamily: global.fontMetropolisRegular, fontWeight: FontWeight.w200, fontSize: 10, overflow: TextOverflow.ellipsis, color: categoriesSelectedIndex == index ? Colors.white : Colors.black),
                        //                                                         ),
                        //                                                       )
                        //                                                     : Container(
                        //                                                         // else  condition
                        ...
                        //                                                           maxLines: 2,
                        //                                                           textAlign: TextAlign.center,
                        //                                                           style: TextStyle(fontFamily: global.fontMetropolisRegular, fontWeight: FontWeight.w200, fontSize: 10, overflow: TextOverflow.ellipsis, color: categoriesSelectedIndex == index ? ColorConstants.appColor : Colors.black),
                        //                                                         ),
                        //                                                       ),
                        //                                               ),
  ...
  _getEventProduct(eventID) async {
    ...
    try {
      ...
      await apiHelper
          .getEventFilteredProducts(eventID, page,catID !=null? catID!.toString():"",isSubCatSelected && (catID !=null && catID!>0)?"sub":!isSubCatSelected && (catID !=null && catID!>0)?"parent":"", _productFilter)
          .then((result) async {
        print(result);
        if (result != null) {
          print("Nikhil 1");
