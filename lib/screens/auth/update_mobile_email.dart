                                                                  ...
                                                                  showCountryPicker(
                                                                    countryListTheme: CountryListThemeData(
                                                                        inputDecoration: InputDecoration(
                                                                            ...
                                                                            label: Text(
                                                                              "Search",
                                                                              style: TextStyle(fontSize: 16, fontFamily: fontRailwayRegular, color: ColorConstants.appColor),
                                                                            )),
                                                                        searchTextStyle: TextStyle(color: ColorConstants.pureBlack),
                                                                        textStyle: TextStyle(fontFamily: fontRailwayRegular, fontWeight: FontWeight.w200, fontSize: 16, color: ColorConstants.pureBlack, letterSpacing: 1)),
                                                                    context:
                                                                        context,
                                                                      ...
                                                                      Padding(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              Expanded(child: Text(countryCodeSelected.contains("+") ? countryCodeSelected : "+${countryCodeSelected}", style: TextStyle(fontFamily: fontRailwayRegular, fontWeight: FontWeight.w200, fontSize: 16, color: ColorConstants.pureBlack, letterSpacing: 1))),
                                                                              Icon(
                                                                ...
                                                                child:
                                                                  ...
                                                                  child:
                                                                    ...
                                                                    decoration: InputDecoration(
                                                                        ...
                                                                        hintText: '561234567',
                                                                        hintStyle: TextStyle(fontFamily: fontRailwayRegular, fontSize: 14) 
                                                                        ),
                                                                  ),
                                                                ),
                                                              ),
