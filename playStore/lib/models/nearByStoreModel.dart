  ...
  NearStoreModel.fromJson(Map<String, dynamic> json) {
    try {
      ...
      storeStatus = json["store_status"] != null
          ? int.parse(json["store_status"].toString())
          : null;
      inactiveReason =
          json["inactive_reason"] != null ? json["inactive_reason"] : null;
      lat = json["lat"] != null ? json["lat"] : null;
      lng = json["lng"] != null ? json["lng"] : null;
      storeOpeningTime = json["store_opening_time"] != null
          ? json["store_opening_time"]
          : null;
      storeClosingTime = json["store_closing_time"] != null
          ? json["store_closing_time"]
          : null;
      ...
      print("Exception - nearByStoreModel.dart - NearStoreModel.fromJson():" +
          e.toString());
    }
  }
}
