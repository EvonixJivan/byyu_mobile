...
class Order {
  ...
  Order.fromJson(Map<String, dynamic> json) {
    try {
      si_order = json['si_order'] != null ? json['si_order'].toString() : '';
      si_sub_ref_no =
          json['si_sub_ref_no'] != null ? json['si_sub_ref_no'].toString() : '';
      orderid = json['group_cart_id'] != null ? json['group_cart_id'].toString() : '';
      ...
      priceWithoutDelivery = json['price_without_delivery'] != null
          ? double.parse('${json['price_without_delivery']}')
          : null;
       
      totalProductsMrp = json['total_products_mrp'] != null
          ? double.parse('${json['total_products_mrp']}')
          : null;
      ...
      remPrice = json['rem_price'] != null
          ? double.parse('${json['rem_price']}')
          : null;
       
      avgTaxPer = json['avg_tax_per'] != null
          ? double.parse(json['avg_tax_per'].toString()).round()
          : null;
       
      totalTaxPrice = json['total_tax_price'] != null
          ? double.parse('${json['total_tax_price']}')
          : null;
      ...
      deliveryCharge = json['delivery_charge'] != null
          ? double.parse('${json['delivery_charge']}')
          : null;
       
      timeSlot = json['time_slot'] != null ? json['time_slot'] : null;
       
      dboyId = json['dboy_id'] != null
          ? int.parse(json['dboy_id'].toString())
          : null;
       
      orderStatus = json['order_status'] != null ? json['order_status'] : null;
       
      userSignature =
          json['user_signature'] != null ? json['user_signature'] : '';
       
      cancellingReason =
          json['cancelling_reason'] != null ? json['cancelling_reason'] : '';
       
      couponId =
          json['coupon_id'] != null ? json['coupon_id'].toString() : null;
       
      couponDiscount = json['coupon_discount'] != null
          ? double.parse('${json['coupon_discount']}')
          : null;
       
      discountonmrp = json["discountonmrp"] != null
          ? double.parse('${json["discountonmrp"]}')
          : 0;
       
      paymentStatus =
          json['payment_status'] != null ? json['payment_status'] : null;
       
      cancelByStore = json['cancel_by_store'] != null
          ? int.parse(json['cancel_by_store'].toString())
          : null;
       
      dboyIncentive = json['dboy_incentive'] != null
          ? double.parse(json['dboy_incentive'].toString()).round()
          : null;
      ...
      pending =
          json['pending'] != null && json['pending'] == "true" ? true : false;
       
      confirm =
          json['confirm'] != null && json['confirm'] == "true" ? true : false;
       
      outForDelivery =
          json['out_for_delivery'] != null && json['out_for_delivery'] == "true"
              ? true
              : false;
       
      completed = json['completed'] != null && json['completed'] == "true"
          ? true
          : false;
       
      cancelled = json['cancelled'] != null && json['cancelled'] == "true"
          ? true
          : false;
      ...
      total_delivery = json['total_delivery'] != null
          ? int.parse(json['total_delivery'].toString())
          : null;
       
      is_subscription = json['is_subscription'] != null
          ? int.parse(json['is_subscription'].toString())
          : null;
      ...
      repeatOrders =
          json['repeat_orders'] != null ? json['repeat_orders'] : null;
       
      total_mrp = json['total_mrp'] != null
          ? double.parse('${json['total_mrp']}')
          : null;
