class Wallet {
  ...
  Wallet.fromJson(Map<String, dynamic> json) {
    try {
      ...
      walletRechargeHistory = json["wallet_recharge_history"] != null
          ? int.parse(json["wallet_recharge_history"].toString())
          : null;
      userId = json["user_id"] != null
          ? int.parse(json["user_id"].toString())
          : null;
      rechargeStatus =
          json["recharge_status"] != null ? json["recharge_status"] : null;

      amount =
          json['amount'] != null ? double.parse('${json['amount']}') : null;

      paidbywallet = json['paid_by_wallet'] != null
          ? double.parse('${json['paid_by_wallet']}')
          : null;
      ...
      updatedAt = json["updated_at"] != null
          ...
          : null;
      dateOfRecharge =
          json["date_of_recharge"] != null ? json["date_of_recharge"] : null;
      memPlanStart = json["mem_plan_start"] != null
          ? DateTime.parse(json["mem_plan_start"])
          : null;
      memPlanExpiry = json["mem_plan_expiry"] != null
          ? DateTime.parse(json["mem_plan_expiry"])
          : null;
      delivery_date =
