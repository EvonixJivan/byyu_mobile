                              ...
                              child: Column(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    height: _productContainerheight-10,
                                    child: _isDataLoaded &&
        ...
        await apiHelper
          ...
          if (result != null) {
            ...
            for (int i = 0; i < _homeScreenData!.events!.length; i++) {
              ...
              if(_homeScreenData!.events![i].eventImage !=null && _homeScreenData!.events![i].eventImage!.trim() != "N/A" && _homeScreenData!.events![i].eventImage! != "n\a")  {
                print(_homeScreenData!.events![i].eventImage);
                bannerEventIconURL.add(new EventIconName(_homeScreenData!.events![i].id, _homeScreenData!.events![i].eventName! ,
