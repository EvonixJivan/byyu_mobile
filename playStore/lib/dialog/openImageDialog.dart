...
class OpenImageDialog extends Base {
  ...
  OpenImageDialog({a, o, this.imageList, this.index, this.name})
      : super(analytics: a, observer: o);
  @override
  OpenImageDialogState createState() =>
      OpenImageDialogState(this.imageList!, this.index!, this.name!);
}
        ...
        builder: (BuildContext context, int index) {
          return PhotoViewGalleryPageOptions(
            imageProvider: CachedNetworkImageProvider(
                "${global.imageBaseUrl}${imageList[index].image}"),
