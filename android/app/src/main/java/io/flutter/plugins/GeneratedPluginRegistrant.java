...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new com.example.checkout_flutter.CheckoutFlutterPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin checkout_flutter, com.example.checkout_flutter.CheckoutFlutterPlugin", e);
    }
    try {
