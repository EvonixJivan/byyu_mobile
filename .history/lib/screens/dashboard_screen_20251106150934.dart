...
class _DashboardScreenState extends BaseRouteState with WidgetsBindingObserver {
  ...
  // }) {
  //   return Container(
  //     width: 160, // adjust for screen (or use MediaQuery for responsiveness)
  ...
  //           fit: BoxFit.contain,
  //           // color:
  //           //     ColorConstants.appColor, // optional tint (remove if full-color)
  //         ),
  ...
  Widget _buildFeatureCard({
    ...
    const double cardHeight = 90; // height tuned to match design
  ...
  Widget _featureCard({
    ...
    const double cardHeight = 96; // exact height to match your reference
    return Container(
      width: width,
      height: cardHeight,
      padding: const EdgeInsets.symmetric(horizontal: 12, vertical: 10),
        ...
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              ...
              // use transparent background if your icon is already shaped,
              // or use Colors.white for a white circle as in some designs.
              color: Colors.white,
            ),
            child: Center(
              child: Image.asset(
                ...
                height: 26,
                fit: BoxFit.contain,
                // If your image is single-color and you want to tint it:
                // color: ColorConstants.appColor,
              ),
            ),
          ),
            ...
            ? Container(
                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(children: [
                      ...
                      //   color: const Color(
                      //       0xFFF2E1CF), // beige background like your sample
