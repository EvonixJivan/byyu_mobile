      ...
      await apiHelper.getCheckOutOrderDetails(cartID!).then((result) async {
        if (result != null) {
          if (result.status == "1") {
            ...
            print(checkoutOrderModel);
            print("-------------delivery addres-------");
            print(checkoutOrderModel!.orderDetails![0].deliveryAddress!);

            FirebaseAnalyticsGA4().callAnalyticsCheckOutNew(
                checkoutOrderModel!.orderDetails != null
                    ? checkoutOrderModel!.orderDetails!
                    : [],
                0,
                checkoutOrderModel!.orderDetails![0].couponId != null
                    ? checkoutOrderModel!.orderDetails![0].couponId!
                    : "",
                checkoutOrderModel!.totalCouponDiscount != null
                    ? checkoutOrderModel!.totalCouponDiscount!
                    : 0,
                checkoutOrderModel!.orderDetails![0].deliveryAddress != null
                    ? checkoutOrderModel!.orderDetails![0].deliveryAddress!
                    : "",
                cartID != null ? cartID! : "");
            checkoutOrderModel = result.data;
