    ...
    return WillPopScope(
        ...
        child: Scaffold(
          floatingActionButton: FloatingActionButton(
            ...
            backgroundColor: ColorConstants.newAppColor, // your app color
            elevation: 3, // light shadow
            child: const Icon(
              Icons.filter_list, // thin filter icon
              size: 22, // smaller/thin look
              color: Colors.white,
            ),
          ),
