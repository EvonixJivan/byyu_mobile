                    ...
                    children: [
                      for (int idx = 0; idx < visibleCount; idx++) ...[
                        _buildCheckboxTile(
                          ...
                          option: options[idx],
                          checked:
                              selectedOptions[category]!.contains(options[idx]),
                          onToggle: () => toggleOption(category, options[idx]),
                        ),
                  ...
                  child: Row(
                    children: [
                      ...
                      ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          backgroundColor: Color(0xff8B4A26),
                          minimumSize: const Size(140, 46),
                          shape: RoundedRectangleBorder(
                              borderRadius: BorderRadius.circular(8)),
                        ),
  ...
  Widget _buildCheckboxTile({
    ...
    return Container(
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(8),
        border: Border.all(
          color: checked ? Color(0xff8B4A26) : Colors.grey.shade300,
          width: 0.5,
        ),
      ),
      child: CheckboxListTile(
        ...
        // Checkbox styling
        activeColor: Color(0xff8B4A26),
        checkColor: Colors.white,

        title: Text(
          option,
          style: TextStyle(
            color: checked ? Color(0xff8B4A26) : Colors.black87,
            fontSize: 14,
