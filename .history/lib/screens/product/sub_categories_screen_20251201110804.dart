...
//FILTER EXPANDED UI BELOW
  Widget buildFiltersDrawerExpansion(
    ...
    // track expansion state if you want to control initial open/close
            ...
            builder: (context, setState) {
              ...
              Widget buildExpansionListTile(String category) {
                ...
                return ExpansionTile(
                  ...
                  children: [
                    // Use a constrained container for the list to avoid infinite height
                    Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (ctx, idx) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              color:
                                  checked ? Colors.black12 : Colors.transparent,
                              borderRadius: BorderRadius.circular(8),
                            ),
                            child: CheckboxListTile(
                              value: checked,
                              onChanged: (_) => toggleOption(category, opt),
                              title: Text(
                                opt,
                                style: const TextStyle(
                                  // you can set a static text color here; modify as needed
                              ...
                              activeColor:
                                  Colors.black, // checkbox fill when checked
              ...
              return Column(
                children: [
                  ...
                  // Expanded list of ExpansionTiles
                  Expanded(
                    child: ListView.builder(
