                                                        ...
                                                        ClipRRect(
                                                          ...
                                                          child:
                                                            ...
                                                            height: MediaQuery.of(
                                                                ...
                                                                2,
                                                            fit: BoxFit.cover,
                                                            imageUrl: _wishListProductList[index]
                                                                            .thumbnail !=
                                                                        null &&
                                                                    _wishListProductList[
                                                                            index]
                                                            ...
                                                            children: [
                                                              ...
                                                              Row(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  _wishListProductList[index].varient !=
                                                                              null &&
                                                                          _wishListProductList[index].varient!.length >
                                                                              0
                                                                  ...
                                                                  _wishListProductList[index].varient !=
                                                                          ...
                                                                          _wishListProductList[index].varient!.length >
                                                                              0
                                                                      ? _wishListProductList[index].varient![0].discountper.toString().length > 0 &&
                                                                              _wishListProductList[index].varient![0].baseMrp.toString().length > 0
                                                                          ? Container(
                                                                              margin: EdgeInsets.only(left: 5),
                                                                              child: Text(
                                                                                _wishListProductList[index].varient![0].discountper.toString().startsWith("-") ? "${_wishListProductList[index].varient![0].discountper.toString().substring(1)}% off" : "${_wishListProductList[index].varient![0].discountper}% off",
                                                                                style: TextStyle(fontFamily: global.fontMontserratLight, fontSize: 14, color: ColorConstants.appColor),
                                                                              ),
                                                                            )
                                                                          : SizedBox()
                                                                      : SizedBox()
                                                                    ...
                                                                    child: Row(
                                                                      ...
                                                                      children: [
                                                                        Expanded(
                                                                          child:
                                                                            ...
                                                                            child:
                                                                                Container(
                                                                              width: 120,
                                                                              decoration: BoxDecoration(color: ColorConstants.appColor, borderRadius: BorderRadius.circular(10)),
                                                                              padding: EdgeInsets.only(top: 8, bottom: 8, left: 5, right: 5),
                                                                              margin: EdgeInsets.only(right: 0.1),
                                                                              // child:
                                                                              //     Icon(
                                                                              //   MdiIcons
                                                                              //       .cart,
                                                                        ...
                                                                        InkWell(
                                                                          ...
                                                                          onTap:
                                                                              () {
                                                                            _addRemoveWishList(_wishListProductList[index].varientId!,
                                                                                index);
                                                                            setState(() {});
                                                                          },
                                                                          child:
          ...
          await apiHelper
            ...
            if (result != null) {
              if (result.status == "1") {
                ...
                print(
                    "Niks-----------11111111-------_>>>>>>>${_wishListProductList.length}>>>>");

                if (_wishListProductList == null ||
