...
class _SearchResultsScreenState extends BaseRouteState {
  ...
  @override
  void initState() {
    print("PRINTTTTTT ABHII111111>>>>>>>>>>>>>>>>>>>>>>>>>>>");
    print(searchParams);
    print("PRINTTTTTT ABHII222222>>>>>>>>>>>>>>>>>>>>>>>>>>>");
    print(searchScreen);
    print("PRINTTTTTT ABHII333333>>>>>>>>>>>>>>>>>>>>>>>>>>>");
    print(subCatName);
    print("PRINTTTTTT ABHII444444444>>>>>>>>>>>>>>>>>>>>>>>>>>>");
    print(subCatID);
    print("PRINTTTTTT ABHII55555555>>>>>>>>>>>>>>>>>>>>>>>>>>>");
    super.initState();
