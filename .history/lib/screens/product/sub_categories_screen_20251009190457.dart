      ...
      appBar: AppBar(
        ...
        actions: [
          InkWell(
            ...
            child: Padding(
                  padding: EdgeInsetsGeometry.only(top:18,bottom:18),
                  child: Image.asset(
        ...
        if (_isRecordPending) {
          ...
          await apiHelper.getCategoryList(page).then((result) async {
            if (result != null) {
              ...
              print("Niks all global.isSubCatSelected------------>${global.isSubCatSelected}  ");
              ...
              if (categoriesSelectedIndex != null &&
                ...
                for (int i = 0;
                  ...
                  if(global.homeSelectedCatID==_categoryList[categoriesSelectedIndex!]
                      .subcategory![i]
                      .catId){
