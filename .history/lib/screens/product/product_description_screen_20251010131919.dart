  ...
  Widget _productWeightAndQuantity(TextTheme textTheme, CartController value) {
    return Padding(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _productDetail.productDetail!.vegOrNonveg != null && _productDetail.productDetail!.vegOrNonveg! != 0 && 
                  _productDetail.productDetail!.vegOrNonveg! <= 2
              ? Container(
                  height: 50,
                  width: MediaQuery.of(context).size.width,
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                    ...
                    child: _productDetail.productDetail!.delivery != null &&
                                _productDetail.productDetail!.delivery == "1" ||
                            _productDetail.productDetail!.delivery == "Today"
                        ? Text(
                            "Express",
                            style: TextStyle(
                                fontFamily: global.fontRailwayRegular,
                        ...
                        : _productDetail.productDetail!.delivery != null &&
                                    _productDetail.productDetail!.delivery ==
                                        "2" ||
                                _productDetail.productDetail!.delivery ==
                                    "Tomorrow"
