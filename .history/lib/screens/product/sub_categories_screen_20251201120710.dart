...
class _SubCategoriesScreenState extends BaseRouteState {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      drawer:
          //buildFiltersDrawer
          buildFiltersDrawerExpansionFixed(
        context,
        productsFound: 5191,
...
//FILTER EXPANDED UI BELOW
  Widget buildFiltersDrawerExpansionFixed(
    BuildContext context, {
    int productsFound = 0,
    required void Function(Map<String, List<String>> selectedFilters) onApply,
  }) {
    ...
    // local mutable state captured by StatefulBuilder
    final Map<String, Set<String>> selectedOptions = {
      for (var c in categories) c: <String>{}
    };
    ...
    // maximum number of items to show inside the ExpansionTile before showing "View more"
        ...
        child: SafeArea(
          child: StatefulBuilder(
            builder: (context, setState) {
              ...
              Widget buildExpansionListTile(String category) {
                final options = staticOptions[category] ?? <String>[];
                final int visibleCount = options.length <= maxVisibleItems
                    ? options.length
                    : maxVisibleItems;
                final bool hasMore = options.length > maxVisibleItems;

                return ExpansionTile(
                  key: PageStorageKey<String>('expansion_$category'),
                  initiallyExpanded: expansionState[category] ?? false,
                  iconColor:
                      ColorConstants.appColor, // arrow color when expanded
                  collapsedIconColor:
                      ColorConstants.appColor, // arrow color when collapsed
                  title: Text(
                    category,
                    style: TextStyle(
                      color: ColorConstants.appColor,
                  ...
                  children: [
                    ...
                    // Safe Column showing limited items (no ListView / no SingleChildScrollView here)
                    Column(
                      crossAxisAlignment: CrossAxisAlignment.stretch,
                      children: [
                        for (int idx = 0; idx < visibleCount; idx++) ...[
                          Container(
                            ...
                            decoration: BoxDecoration(
                              color: selectedOptions[category]!
                            ...
                            child: CheckboxListTile(
                              ...
                              activeColor: Colors.black, // fill when checked
                        ...
                        // View more button (opens a dialog with full list inside safe, bounded area)
                        if (hasMore)
                          Padding(
                            padding: const EdgeInsets.symmetric(
                                                  ...
                                                  Container(
                                                    ...
                                                    child: CheckboxListTile(
                                                      value: selectedOptions[
                                                          ...
                                                          .contains(opt),
                                                      onChanged: (_) {
                                                        // toggle and rebuild dialog quickly by popping+reopening
                                                        toggleOption(
                                                            category, opt);
                                                        // instead of complex state sync inside dialog, pop to reflect change
                                                        // and reopen immediately to show updated selection
                                                        ...
                                                        Future.delayed(
                                                          ...
                                                          showDialog(
                                                            context: context,
                                                            builder: (_) {
                                                              // Rebuild a similar dialog (simple approach)
                                                              return AlertDialog(
                                                                title: Text(
                                                                    'More $category'),
                                                                content:
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      children: [
                                                                        for (var o
                                                                          ...
                                                                          CheckboxListTile(
                                                                            value:
                                                                                selectedOptions[category]!.contains(o),
                                                                            onChanged:
                                                                                (_) {
                                                                              toggleOption(category, o);
                                                                            },
                                                                            title:
                                                                                Text(o),
                                                                          ),
                      ...
                      children: [
                        IconButton(
                          icon: Icon(Icons.arrow_back_ios,
                              color: ColorConstants.newAppColor, size: 20),
                          onPressed: () => Navigator.of(context).maybePop(),
                        ),
                        const SizedBox(width: 8),
                        Text(
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, i) {
                        ...
                        return buildExpansionListTile(cat);
                      },
                    ),
                  ),
