...
//FILTER EXPANDED UI BELOW
  Widget buildFiltersDrawerExpansion(
    ...
    // track expansion state (explicit bools)
    ...
    return SizedBox(
      ...
      child: Drawer(
        ...
        child: SafeArea(
          child: StatefulBuilder(
            builder: (context, setState) {
              // Toggle a single option in a category
              ...
              // Build a single expansion tile safely
              Widget buildExpansionListTile(String category) {
                final List<String> options =
                    staticOptions[category] ?? <String>[];
                // explicit max height to prevent unbounded height errors
                const double listMaxHeight = 240.0;
                ...
                return ExpansionTile(
                  ...
                  title: Text(
                    ...
                    style: const TextStyle(
                      // Replace these with your ColorConstants if available
                      color: Colors.brown,
                  ...
                  children: [
                    // Constrain inner list to avoid layout issues
                    Container(
                      constraints: BoxConstraints(
                        maxHeight: listMaxHeight,
                        // optional minHeight if you want:
                        minHeight: options.isEmpty ? 40.0 : 0.0,
                      ),
                      child: options.isEmpty
                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (ctx, idx) {
                                ...
                                final bool checked =
                                    selectedOptions[category]!.contains(opt);
                                ...
                                return Container(
                                  ...
                                  child: CheckboxListTile(
                                    ...
                                    controlAffinity:
                                        ListTileControlAffinity.leading,
                                    activeColor:
                                        Colors.black, // checkbox fill color
                    ...
                    child: Row(
                      children: [
                        ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                            backgroundColor: Colors.white,
                            minimumSize: const Size(140.0, 46.0),
                            shape: RoundedRectangleBorder(
                                borderRadius: BorderRadius.circular(8.0)),
