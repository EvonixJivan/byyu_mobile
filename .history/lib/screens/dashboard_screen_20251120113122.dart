                ...
                child: SingleChildScrollView(
                    ...
                    child: Column(children: [
                      ...
                      _homeScreenData!.banner != null &&
                          ...
                          // _homeScreenData?.banner != null &&
                          //         _homeScreenData!.banner!.isNotEmpty &&
                          //         bannerEventImageURL.isNotEmpty &&
                          //         bannerEventImageURL.any(
                          //             (url) => url.trim().toLowerCase() != "n/a")
                          ? Container(
...
//////Setion 3 products starts here
  ...
  void initState() {
    ...
    // print(
    //     "CHECKPOINT EVENTBANNER IMAGE>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>> ${_homeScreenData!.events}");
    super.initState();
          ...
          if (result != null) {
            ...
            if (_homeScreenData?.eventsbanner != null &&
              ...
              for (final eb in _homeScreenData!.eventsbanner!) {
                final bannerImg = eb.eventBannerImg;
                if (bannerImg != null) {
                  ...
                  if (trimmed.isNotEmpty && trimmed.toLowerCase() != 'n/a') {
                    ...
                    final path = trimmed.startsWith('/')
                        ...
                        : trimmed;
                    print(
                        "checkpoinntnntttttt>>>>>>>>>>>>>>>>11122211111 ${_homeScreenData?.eventsbanner!.toList()}");
