          ...
          if (result != null) {
            ...
            if (_homeScreenData!.eventsbanner != null &&
              ...
              for (int i = 0; i < _homeScreenData!.eventsbanner!.length; i++) {
                if (_homeScreenData!.eventsbanner![i].event_banner_img !=
                        null &&
                    _homeScreenData!.eventsbanner![i].event_banner_img!.length >
                        0 &&
                    _homeScreenData!.eventsbanner![i].event_banner_img!
                            .trim() !=
                        "N/A") {
                  // print(global.imageBaseUrl +
                  //     _homeScreenData!.events![i].event_banner_img! +
