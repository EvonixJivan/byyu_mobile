...
//new APPLY COUPON CODE
                                                          return GestureDetector(
                                                            onTap: () async {
                                                              // If you want UI updates to reflect immediately, wrap only the synchronous state changes
                                                              setState(() {
                                                                // nothing here yet — we'll call setState in each branch when needed
                                                              });

                                                              if (isCardSelected ==
                                                                  true) {
                                                                // Card was selected — clear coupon state and recalc UI flags
                                                                setState(() {
                                                                  couponName =
                                                                      "";
                                                                  CouponColor =
                                                                      false;
                                                                  // keep isCardSelected true (no assignment mistake)
                                                                  isCardSelected =
                                                                      true;
                                                                  ...
                                                                  // recalc temp amount (if you need to store)
                                                                  var tamount =
                                                                      totalAmount -
                                                                          couponDiscount;
                                                                  // call wallet removal effect if that changes state/UI
                                                                  walletAppliedRemoved();

                                                                  // update alert visibility based on amount
                                                                  if ((addAmount - couponDiscount).toStringAsFixed(2) == "0.00" ||
                                                                      (addAmount - couponDiscount).toStringAsFixed(
                                                                              2) ==
                                                                          "-0.00" ||
                                                                ...
                                                                // Card not selected -> apply coupon
                                                                final couponCode =
                                                                    item.couponCode ??
                                                                        "";

                                                                // If apply function requires non-empty code, you may early-return or show error:
                                                                if (couponCode
                                                                    .isEmpty) {
                                                                  // show some toast / set state to display error if needed
                                                                  setState(() {
                                                                    boolCouponCodeError =
                                                                        true;
                                                                    strCouponCodeError =
                                                                ...
                                                                // call apply coupon (await) and then update UI
                                                                try {
                                                                  await _applyCoupon(
                                                                      couponCode);

                                                                  setState(() {
                                                                    // record the coupon name (guard null)
                                                                    couponName =
                                                                        item.couponName ??
                                                                            "";

                                                                    // After applying coupon you may want to toggle UI flags:
                                                                    isCouponCodeVisible =
                                                                        false;
                                                                    showCouponField =
                                                                        false;
                                                                    // optionally set couponDiscount from the response inside _applyCoupon
                                                                  });
                                                                } catch (e) {
                                                                  // handle apply error
                                                                  print(
                                                                      "Apply coupon failed: $e");
                                                                  // optionally set state to show error
                                                                }
                                                              }
                                                            },
                                                            child: Container(
                                                              ...
                                                              child: Column(
                                                                ...
                                                                children: [
                                                                    ...
                                                                    children: [
                                                                      GestureDetector(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          size:
                                                                              18,
                                                                          color: (CouponColor == true && couponName == item.couponName)
                                                                  ...
                                                                  // 🔥 Expiry Date (dynamic)
                                                                  Text(
                                                                    "Expiry Date: ${formatCouponDate(item.endDate.toString())}",
                                                                    style:
                                                                        TextStyle(
                                                                      fontSize:
                                                                          10,
                                      ...
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                          onTap: () async {
                                            ...
                                            print(
                                                "G1----selected add 2---->${selectedAddressID}");
          ...
          child: InkWell(
            onTap: () {
              ...
              if (currentUser == null || currentUser.id == null) {
                ...
                print("G1---date---->$selectedDate");
                print("G1---time---->$selectedTime");
                print("G1---timeq---->$_selectedTime");
                if (selectedDate.toString().length == 0 ||
                    selectedTime == null) {
                  setState(() {
                    deliveryDateEmpty = true;
                  ...
                  deliveryDateEmpty = false;
                  deliveryTimeEmpty = false;
                  print("---------TAPCUSTOMERIDDDDD>>>>>>>>>11>>>>");
                  print(global.appInfo.tapcustomer_id);
        ...
        await apiHelper
          ...
          if (result != null) {
            if (result.status == "1") {
              ...
              print("Abhishek COUPON LISTTTTTTTTTTT---------------------3");
            }
          }
        });
      } else {
...
// GET COUPON LIST ABOVE CODE -----------------------------
  ...
  void initState() {
    ...
    //   // 🔄 Refresh UI after updating variable
    //   WidgetsBinding.instance.addPostFrameCallback((_) {
    //     setState(() {});
    //   });
    // }

    // // If empty list → avoid crash
    // else {
      ...
      if (isCouponCodeVisible && selectedPaymentType == "COD") {
        ...
        if (isWalletSelected &&
          ...
          if (updateDateSuccess == 1) {
            await apiHelper
              ...
              if (result != null) {
                ...
                hideloadershowing();
                print(
                    '----------------------Abhiiii111111111--------->${result.message}');
          ...
          if (updateDateSuccess == 1) {
            await apiHelper
              ...
              if (result != null) {
                ...
                hideloadershowing();
                print('ABHIIIII2222222222222-------->${result.message}');
                paymentErrorMSG = "Something went wrong. Please try again";
                showPaymentError = true;
                btnProceedName = "RETRY";
                setState(() {});
          ...
          if (selectedPaymentType == "Card") {
            print(
                "G1----->make order---->${global.currentUser.id == null ? siginInResponse!.userId : global.currentUser.id}, selectedDate: ${selectedDate},  selectedTime: ${selectedTime},  paymentType: ${selectedPaymentType},  description: "
                ", totalAmount: ${(totalOrderPrice + totalDeliveryCharge!).toStringAsFixed(2)},  totalDelivery: ${global.total_delivery_count},  selectedAddressID: ${selectedAddressID}, coupon_code: ${couponCodeStr},walletmount: ${!isWalletSelected ? "0.0" : "${totalWalletSpendings}"}, message: ${selectedOccasionString.text != null ? selectedOccasionString.text : ""}, coupon_amount: ${couponDiscount.toString()}, si_sub_ref_no: ${si_sub_ref_no} ");
            hideloadershowing();
            ...
            if (updateDateSuccess == 1) {
              await apiHelper
                ...
                if (result != null) {
                  ...
                  print('ABHIIIII333333333333333-------->${result.message}');
                  hideloadershowing();
                  showPaymentError = true;
                  paymentErrorMSG = "Something went wrong! Please try again";
                  setState(() {});
...
//TERMS AND CONDITION BOTTOM SHEET ABHISHEK BELOW
  void _showCouponInfoSheet(BuildContext context, dynamic item) {
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                // ---------- Coupon T&C Text ----------
                Text(
                  item.term_and_conditions ?? "No terms available",
                  style: const TextStyle(
                    fontSize: 14,
                    height: 1.4,
                    fontWeight: FontWeight.w400,
  ...
  String formatCouponDate(String? rawDate) {
    try {
      if (rawDate == null || rawDate.isEmpty) return "";
      final dt = DateTime.parse(rawDate);
      return global.monthInIntFormt.format(dt);
    } catch (e) {
      return "";
    }
  }
//TERMS AND CONDITION BOTTOM SHEET ABHISHEK ABOVE
