                  ...
                  ? InkWell(
                      ...
                      child: Container(
                        ...
                        child: Icon(Icons.notifications_none,
                            size: 25, color: ColorConstants.newAppColor),
                      ),
                    )
                  : SizedBox(),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    addressList.isEmpty
                                        ? Row(
                                            children: [
                                              // --- Delivery Date Field with Calendar Icon ---
                                              Expanded(
                                                child: Column(
                                                  children: [
                                                    GestureDetector(
...
// --- Select Time (horizontal list using existing timeSlotsDropDown) ---
                                              Expanded(
                                                child: Column(
                                                  crossAxisAlignment:
                                                      CrossAxisAlignment.start,
                                                  children: [
                                                    // If no date selected show disabled hint
                                                    if (selectedDate ==
                                                        null) ...[
                                                      Container(
                                                        height: 48,
                                                      ...
                                                      // Date is selected -> show horizontal time slots (or loading/empty)
                                                      Container(
                                                        height: 68,
                                                        child:
                                                            isLoadingTimeSlots
                                                                    ...
                                                                    : ListView
                                                                        ...
                                                                        itemBuilder:
                                                                          ...
                                                                          final slotName = (item is DropDownValueModel)
                                                                              ...
                                                                              : item.toString();
                                                                          final isSelected =
                                                                              _selectedTime == slotName || selectedTime == slotName;
                                                                          ...
                                                                          return GestureDetector(
                                                                            onTap:
                                                                              ...
                                                                              setState(() {
                                                                                ...
                                                                                // if you need to update a controller:
                                                                                // myTimeController.text = slotName;
                                                                              });
                                                                            },
                                                                            child:
                                                                                AnimatedContainer(
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                color: isSelected ? Color(0xFF8B4513) : ColorConstants.white, // brown when selected
                                                                                borderRadius: BorderRadius.circular(10),
                                                                                border: Border.all(
                                                                                  color: isSelected ? Color(0xFF8B4513) : ColorConstants.grey,
                                                                                  width: 0.8,
                                                                                ),
                                                                              ),
                                                                              child: Center(
                                      ...
                                      itemBuilder: (context, index) {
                                        return GestureDetector(
                                          onTap: () async {
                                            ...
                                            // global.currentLocationSelected = true;
                                    ...
                                    global.currentUser != null &&
                                        ...
                                        : SizedBox(),
                                    SizedBox(
                                        height: global.currentUser != null &&
                                                global.currentUser.id != null &&
                                                addressList.length > 0
                                            ? 10
                                            : 0),
    ...
    try {
      await apiHelper.SaveGuestUserAddress(
        ...
        if (result != null && result.data["status"] == true) {
          print("dkjfhkjdsfkjdf sdnfojsdfo dsnfj");
    ...
    try {
      GoSellSdkFlutter.sessionConfigurations(
        ...
        customer: Customer(
          ...
          email:
              global.currentUser.email != null ? global.currentUser.email! : "",
