                                      ...
                                      child: Container(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            ...
                                            else if (addressList[index].type !=
                                                    null &&
                                                addressList[index]
                                                        .type!
                                                        .toLowerCase() ==
        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: InkWell(
            onTap: () {
              ...
              print(totalOrderPrice + totalDeliveryCharge!);
              print(global.total_delivery_count);
              print(selectedAddressID);
              print(couponCodeStr);
              print(totalWalletSpendings);
              print(couponDiscount);

              print("$guestEmail+abc");
              print(guestName);
              print(guestContactNumber);
              print(guestDeliveryName);
              print(guestDeliveryContact);
              print(guestDeliveryEmail);
              print(guestDeliveryTimeSlot);
              print(guestAddress);
              print(isCardSelected);
            },
            child: Container(
              decoration: BoxDecoration(
                color: ColorConstants.appColor,
...
////##################### condition if wallet+coupon amount is smaller than order
  ...
  void callbackPaymentSetState(CartController cartController) {
    print("paymentsetstate is getting called: $cartController");
    setState(() {
