                                        ...
                                        onTap: () async {
                                          ...
                                          final DateTime? pickedDate =
                                            ...
                                            initialDate: DateTime
                                                .now(), // start from current date
                                            firstDate: DateTime
                                                .now(), // disable previous dates
                                            lastDate: DateTime(
                                                2100), // reasonable future limit
                                                ...
                                                data:
                                                  ...
                                                  colorScheme:
                                                    ...
                                                    primary: ColorConstants
                                                        .appColor, // header background / selected date
                                                    onPrimary: Colors
                                                  ...
                                                  textButtonTheme:
                                                    ...
                                                    style: TextButton.styleFrom(
                                                      foregroundColor:
                                                          ColorConstants
                                                              .appColor, // cancel/ok button color
                                                    ),
                                                  ),
                                                ),
                                                child: child!,
                                    ...
                                    timeSlotsDropDown.length > 0
                                        ? Expanded(
                                            child: Container(
                                              height: 48,
                                              decoration: BoxDecoration(
                                                // ✅ MATCHED BORDER STYLE (same as Select Date)
                                                border: Border.all(
                                                  color: ColorConstants
                                                      .newTextHeadingFooter
                                                      .withOpacity(0.4),
                                  ...
                                  itemBuilder: (context, index) {
                                    return Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          // 🏠 Home Icon
                                          if (addressList[index].type != null &&
                                              addressList[index]
                                                      .type!
                                                      .toLowerCase() ==
                                                  'home')
