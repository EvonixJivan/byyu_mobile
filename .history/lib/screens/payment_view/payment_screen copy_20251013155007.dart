  ...
  children: [
    ...
    Expanded(
      child: GestureDetector(
        onTap: () async {
          ...
          if (pickedDate != null) {
            setState(() {
              ...
              loggedindeliveryDateController.text = guestDeliveryDate!;
        ...
        child: AbsorbPointer(
          child: TextField(
            controller: loggedindeliveryDateController,
            style: TextStyle(
              fontFamily: global.fontOufitMedium,
              fontSize: 15,
              color: ColorConstants.newTextHeadingFooter,
            ...
            decoration: _inputDecoration("Delivery Date").copyWith(
              suffixIcon: Padding(
                ...
                child: Image.asset(
                  ...
                  height: 20,
                  width: 20,
                  color: ColorConstants.appColor, // optional tint
                ),
              ),
            ),
            readOnly: true,
    ...
    Expanded(
      child: Container(
        ...
        child: DropDownTextField(
          isEnabled: timeSlotsDropDown.isNotEmpty,
          clearOption: false,
          ...
          dropDownItemCount: timeSlotsDropDown.length,
