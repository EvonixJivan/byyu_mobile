...
class FilterCustomSheet extends StatefulWidget {
  ...
  FilterCustomSheet({this.showFilters, this.filterTypeIndex});
    ...
    return _isDataLoaded
        ? Container(
            ...
            padding: EdgeInsets.fromLTRB(
                    ...
                    0,
                    0,
                    MediaQuery.of(context).viewPadding.bottom+5, // Prevents bottom overlap
                  ),
                              ...
                              filterTypeIndex == 3
                                  ? Container(
                                      child: ListView.builder(
                                          shrinkWrap: true,
                                          itemCount: global
                                              .globalShowFilters.filterOcassion!.length,
                                          scrollDirection: Axis.vertical,
                                          itemBuilder: (BuildContext context,
                                              int index) {
                                            return Container(
