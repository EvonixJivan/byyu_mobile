    ...
    try {
      ...
      if (response.statusCode == 200 && status == "1") {
        ...
        if (rawData == null) {
          ...
          // data is an array → parse to list
          parsedList = rawData
              .map((x) => NewFilterModel.fromJson(x as Map<String, dynamic>))
              .toList();
        } else if (rawData is Map) {
          // data is a map/object → keep both map and list forms
          ...
          // also produce a list if you want a uniform shape in UI
        ...
        // choose what to return in "data" key (I return the parsedList for easier UI handling)
        recordList = parsedList;
      ...
      return {
        ...
        "data": recordList, // List<NewFilterModel> or null
        "raw": response.data,
        // optionally return parsedMap if you want keyed access:
        "parsedMap": parsedMap,
      };
    } catch (e, st) {
