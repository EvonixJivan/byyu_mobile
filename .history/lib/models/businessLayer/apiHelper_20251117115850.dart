...
Future<dynamic> oneAPIfirst() async {
  ...
  try {
    ...
    var formData = global.currentUser.id != null
        ? {'user_id': global.currentUser.id.toString()}
        : {'user_type': " "};
    print("####################Abhishek oneAPI FIRST#######################");
    print('${global.nodeBaseUrl}oneapifirst');

    response = await dio.post('${global.nodeBaseUrl}oneapifirst',
        queryParameters: {
          'user_id': global.currentUser.id != null
              ? {'user_id': global.currentUser.id.toString()}
              : {'user_type': " "},
    ...
    print("Exception - oneAPIFIRST(): " + e.toString());
  }
}
