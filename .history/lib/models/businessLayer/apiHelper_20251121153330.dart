...
"cat_id": $cat_subCat_ID,
"cat_type": $catType,
"sortid": "${productFilter?.filterSortID ?? ""}",
"pricesortid": "${productFilter?.filterPriceID ?? ""}",
"discountsortid": "${productFilter?.filterDiscountID ?? ""}",
"ocassionid": "${productFilter?.filterOcassionID ?? ""}"
""");
