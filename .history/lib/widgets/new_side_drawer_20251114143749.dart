...
class _NewSideDrawerState extends State<NewSideDrawer> {
  ...
  // sample sub-items for categories. Replace icon paths/titles as required.
                ...
                children: [
                  SizedBox(
                    ...
                    child: Image.asset(
                      item.icon,
                      fit: BoxFit.contain,
                      // tint color optional — remove if icons are colored
                      // color: ColorConstants.newAppColor,
          ...
          children: [
            ...
            Expanded(
              child: SingleChildScrollView(
                child: Column(
                  children: [
                    // if categoriesScreen true show detail container, else show original content
                    if (categoriesScreen)
                          ...
                          return GestureDetector(
                            onTap: () {
                              setState(() {
                                ...
                                // If you want to still call external callback:
                          ...
                          Expanded(
                            child: SizedBox(
                              ...
                              child: PromoSmallCard(
                                ...
                                imageUrl:
                                    "assets/images/C1.webp", // asset image
                                onTap: () {},
                              ),
                            ),
                          ),
