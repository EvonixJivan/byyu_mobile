...
class CartMenu extends StatefulWidget {
  ...
  final Function(CartController)? callbackPaymentSetState;
  ...
  CartMenu(
      ...
      this.o,
      this.cartController,
      this.fromPaymentScreen,
      this.homeScreenSetState,
      this.callbackPaymentSetState})
      : super();
  ...
  _CartMenuState createState() => _CartMenuState(
      ...
      fromPaymentScreen: fromPaymentScreen,
  ...
  _getCartList1() async {
    try {
      ...
      if (widget.fromPaymentScreen == true &&
          widget.callbackPaymentSetState != null) {
        print("Calling parent callback...");
        widget.callbackPaymentSetState!(widget.cartController!);
      }
      setState(() {});
    } catch (e) {
      hideloader();
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 8),
                                Text(
                                  "AED ${(cartController!.cartItemsList.cartData!.cartProductdata![index].cartQty! * cartController!.cartItemsList.cartData!.cartProductdata![index].price!).toStringAsFixed(0)}",
                                  style: const TextStyle(
