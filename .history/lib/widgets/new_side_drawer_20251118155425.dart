            ...
            children: [
              ...
              Container(
                ...
                child: RangeSlider(
                  ...
                  divisions: 52, // optional (70 - 18 = 52 steps)
                  labels: RangeLabels(
                    '${_minAge.round()}',
                    '${_maxAge.round()}',
                  ),
                  onChanged: (RangeValues values) {
                    setState(() {
                      _minAge = double.parse(values.start.toStringAsFixed(0));
                      _maxAge = double.parse(values.end.toStringAsFixed(0));
                    });

                    print("Selected Min Age = $_minAge");
                    print("Selected Max Age = $_maxAge");
                  },
                ),
              ),
              Text(
                // 'Selected: ${_sliderPercent(_ageSliderValue)}%',
                'Selected: ${_minAge} - ${_maxAge}',
                style: const TextStyle(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          //       categoryId: item["id"], // must exist in your API
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () {
                          ...
                          print(_minAge);
                          print(_maxAge);
                          print("https://byyu.com/admin${item["icon"]}");
                        ...
                        child: Column(
                          ...
                          children: [
                            SizedBox(
                              ...
                              width: 40,
                              child: Image.network(
                                // "https://byyu.com/admin${item["icon"]}",
                                " https://byyu.com/admin/uploads/search_filter_icon/2025-11-12/mother.svg",
                                fit: BoxFit.cover,
                                errorBuilder: (context, error, stackTrace) =>
                                    Container(
                                  color: Colors.transparent,
