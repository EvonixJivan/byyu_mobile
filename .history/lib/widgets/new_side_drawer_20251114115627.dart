...
class _NewSideDrawerState extends State<NewSideDrawer> {
  ...
  final List<_CategoryItem> _categories = [
    ...
    _CategoryItem(
        title: 'Cakes', imageUrl: 'https://picsum.photos/seed/cake/400'),
    _CategoryItem(
        title: 'Plants', imageUrl: 'https://picsum.photos/seed/plants2/400'),
    _CategoryItem(
        title: 'Personalized', imageUrl: 'https://picsum.photos/seed/pers/400'),
  ];
