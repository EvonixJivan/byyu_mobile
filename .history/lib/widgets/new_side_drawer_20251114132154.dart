...
class _NewSideDrawerState extends State<NewSideDrawer> {
  ...
  final List<_CategoryItem> _categories = [
    _CategoryItem(title: 'Celebrate', imageUrl: "assets/Images/N1.webp"),
    _CategoryItem(title: 'Recipients', imageUrl: "assets/Images/N2.webp"),
    _CategoryItem(title: 'Express Delivery', imageUrl: "assets/Images/N3.webp"),
  ];

  final List<_ChipItem> _chips = [
    _ChipItem(title: 'Flowers & Gifts', iconUrl: "assets/Images/F1.webp"),
    _ChipItem(title: 'Flowers & Plants', iconUrl: "assets/Images/F2.webp"),
  ];
