  ...
  getCartList() async {
    ...
    try {
      ...
      if (cartController.cartItemsList != null) {
        cartItemsList = cartController.cartItemsList;
      } else {
        await apiHelper.showCart().then((result) async {
          print("########################### show cart bottom sheet called");
                      ...
                      children: [
                        Expanded(
                          child: Center(
                            child: Text(
                              "My Cart (" +
                                  cartItemsList!.cartData!.totalItems!
                                      .toString() +
                                  ")",
                                        ...
                                        children: [
                                          ...
                                          Row(
                                            ...
                                            children: [
                                              ...
                                              const SizedBox(width: 8),
                                              Text(
                                                "AED ${(cartItemsList.cartData!.cartProductdata![index].cartQty! * cartItemsList.cartData!.cartProductdata![index].price!).toStringAsFixed(0)}",
                                                style: const TextStyle(
                          ...
                          Expanded(
                            child: InkWell(
                              onTap: () async {
                                ...
                                //     ),
                                //     builder: (context) => AddOnBottomSheet(
