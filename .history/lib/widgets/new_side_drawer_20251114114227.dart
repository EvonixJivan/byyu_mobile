        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
                ...
                children: [
                  const Text(
                    ...
                    style: TextStyle(
                      ...
                      color:
                          ColorConstants.newAppColor, // soft brown as example
                    ),
                  ),
                  IconButton(
              ...
              SizedBox(
                // adjust height as needed to fit the grid
                height: 260,
                child: GridView.builder(
                  ...
                  gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                    crossAxisCount: 2, // 3 items per row (like your original 3)
                    crossAxisSpacing: 12,
                    mainAxisSpacing: 12,
                    childAspectRatio: 1, // tweak to adjust image vs text space
                  ),
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return GestureDetector(
                      ...
                      child: Column(
                        ...
                        children: [
                          // Card-like container with clipped top corners and image
                          Container(
                            width: 92,
                            // height controls image height — tune as required
                            height: 92,
                            decoration: BoxDecoration(
                              borderRadius: BorderRadius.circular(
                                  100), // keeps outer circular look if wanted
                              boxShadow: [
                                BoxShadow(
                            ...
                            child: ClipRRect(
                              ...
                              child:
                                  // ---- STATIC IMAGE ----
                                  // Prefer assets for static images: Image.asset('assets/category_1.png')
                                  // Example uses a network fallback; replace with Image.asset(...) if you have local images.
                                  Image.network(
                                cat.imageUrl,
                                width: 92,
                                height: 92,
