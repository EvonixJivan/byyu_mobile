                      ...
                      Container(
                        ...
                        child: Column(
                          children: [
                            ...
                            global.currentUser != null &&
                                ...
                                ? InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Container(
                                        decoration:
                                            BoxDecoration(color: ColorConstants.colorPageBackground,),
                                        padding: EdgeInsets.only(
                                          top: 12,
                                          bottom: 12,
                                          left: 12,
                            ...
                            Container(
                              width: MediaQuery.of(context).size.width,
                              decoration: BoxDecoration(color: ColorConstants.colorPageBackground),
                              child: Row(
                                children: [
                                  Expanded(
                                    child: InkWell(
                            ...
                            SizedBox(height: 1),
                            global.currentUser.id != null &&
                                    global.stayLoggedIN!?SizedBox(height: 10,):SizedBox(height: 1),
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(
                                        ...
                                        borderRadius: BorderRadius.all(
                                            Radius.circular(7.0))),
                                    padding: EdgeInsets.only(
                                        left: 5, bottom: 10, right: 10, top: 10),
                                    child: Container(
                                      child: Row(
                                        children: [
                                          Expanded(
