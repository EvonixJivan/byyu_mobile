                ...
                children: [
                  ...
                  Container(
                    child: Text(
                          ...
                          style: TextStyle(
                            fontFamily:
                                global.fontRalewayMedium, // replace with global.fontMetropolisRegular
                          ...
                          children: [
                            ...
                            SizedBox(
                              ...
                              child: GridView.builder(
                                  ...
                                  itemCount: selectionData.searchGender!.length,
                                          ...
                                          InkWell(
                                            onTap: () {
                                              ...
                                              recipient = selectionData
                                                  .searchGender![index].name!;
                                              selectedRecipient_ID = selectionData
                                                  .searchGender![index].id!;
                                              for (int i = 0;
                                                  i <
                                                      selectionData
                                                          .searchGender!.length;
                                ...
                                ? Container(
                                    child: Column(
                                      children: [
                                        ...
                                        //   height: 8,
                                        // ),
                                        recipient.toLowerCase() == "male" ||
                                                recipient.toLowerCase() ==
                                                    "female"
                                            ? SizedBox(
                                              height: recipient.toLowerCase() ==
                                                    "female"?320:410,
                                              child: GridView.builder(
                                                shrinkWrap: true,
                                                gridDelegate:
                                                    SliverGridDelegateWithFixedCrossAxisCount(
                                                        crossAxisCount: 3,
                                                        childAspectRatio: 1.2,crossAxisSpacing: 0,mainAxisSpacing: 8),
                                                scrollDirection: Axis.vertical,
                                                itemCount:
                                                    recipient.toLowerCase() ==
                                                            "male"
                                                        ? maleRelation.length
                                                        : femaleRelation.length,
                                            ...
                                            : SizedBox(
                                              ...
                                              child: GridView.builder(
                                                  ...
                                                  gridDelegate:
                                                      SliverGridDelegateWithFixedCrossAxisCount(
                                                          crossAxisCount: 3,
                                                          childAspectRatio: 1,crossAxisSpacing: 0,mainAxisSpacing: 0),
                                                  scrollDirection: Axis.vertical,
